...
Digamos que nosso interesse seja estimar o volume de processos relativos aos assuntos "Indenização por Dano Moral" e "Fornecimento de Medicamentos". Na base de dados baixada, temos exatamente `sum(d_tjsp$assunto %in% leafs)` processos classificados com esse assunto.
